...
def test_package_subpath_mismatched_module():
    err_msg = (
        "Package github.com/bar does not belong to module github.com/foo. "
        "Something went very wrong."
    )
    with pytest.raises(RuntimeError, match=err_msg):
        gomod._package_subpath("github.com/foo", "github.com/bar", ".")
